...
describe("over raise - short level", function() {
    ...
    loger("test name: over raise empty lever");
  ...
  it("GP deposit raising", async function() {
    ...
    const gp1DepositAmount = getBigNumber(200000);
  ...
  it("LP deposit raising", async function() {
    ...
    const lp1DepositAmount = getBigNumber(5000);
  ...
  it("GP deposit running", async function() {
    ...
    const gp2DepositAmount = getBigNumber(50000);
  ...
  it("LP deposit running", async function() {
    ...
    const lp2DepositAmount = getBigNumber(500);
