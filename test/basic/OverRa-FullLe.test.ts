...
describe("over raise - full lever", function() {
  ...
  it("Create pool", async function() {
    ...
    const IPTokenAmountIn = getBigNumber(100000);
    const approveTX = await this.Token1.connect(this.ipAccount1).approve(this.NudgePool.address, IPTokenAmountIn);
  ...
  it("GP deposit raising", async function() {
    ...
    const gp1DepositAmountAmount = getBigNumber(100000);
    const approveGPAccount1TX = await this.Token2.connect(this.gpAccount1).approve(
      this.NudgePool.address, gp1DepositAmountAmount);
  ...
  it("LP deposit raising", async function() {
    ...
    const lp1DepositAmount = getBigNumber(100000);
  ...
  it("GP deposit running", async function() {
    ...
    const gp2DepositAmount = getBigNumber(100000);
  ...
  it("LP deposit running", async function() {
    ...
    const lp2DepositAmount = getBigNumber(400000);
